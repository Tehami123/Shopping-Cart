<?php $basePath = '/Shopping%20Cart'; ?>
    ...
    >
            ...
            <div>
                <h4>Shop</h4>
                <ul>
                    <li><a href="<?= $basePath ?>/products.php">Stationery</a></li>
                    <li><a href="<?= $basePath ?>/products.php">Gift Articles</a></li>
                    <li><a href="<?= $basePath ?>/products.php">Greeting Cards</a></li>
                    <li><a href="<?= $basePath ?>/products.php">Lifestyle</a></li>
                </ul>
            </div>
